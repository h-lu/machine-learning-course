...
32 课各有五个独立定义的知识点，每个知识点配一对 A、B 题，共 320 题。每题使用 `C01-A-01`、`S01-B-05` 这样的稳定编号，页面标题也直接显示课次编号。学生先完成 A 版判断；AI 学习阶段只看到知识点标题与学习说明，不会看到或复述 A、B 题；最后由教师开放 B 版换场景检验。题库版本为 `ml-v4-2026-09-14`。题目答案与解释保留在教师/服务文件中；学生读取接口只返回题干与选项。

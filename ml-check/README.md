...
**本分支使用候选题库 `ml-v8-foundations-2026-09-19`，未部署到生产服务。**C01–C02 与 S01–S06 的材料和题目需要按班级版本一并采用；旧场次不得直接切换当前题库。
...
`ml-v8-foundations-2026-09-19` 保留入门两课，再重写 S01–S06 的 30 个知识点及 60 道 A/B 题。总计仍为 32 课、320 题。前八课 A/学习/B 为 240/300/240 秒，另留 120 秒提交；S07–S30 的题目和原阶段时长不变。

...
## 2026-09-22 v15 实际部署记录

v15 只更新第 05 课（S03）知识点的首次出现术语说明。题库版本为 `ml-v15-s03-terminology-2026-09-22`，`lessons.json` SHA-256 为 `c1993e6876a79a4278d8c1ad17f4ee36996b206e92454f7e184d715fd6d58b7f`，正式镜像为 `ml-check:2026-09-22-v15`。

切换前 4 个场次都处于 `result`，SQLite 完整性检查为 `ok`。切换前备份为：

- 数据库：`/home/ubuntu/ml-check/data/ml-check.before-v15-20260922T082114Z.sqlite3`
- 源码与部署文件：`/home/ubuntu/ml-check/backups/source-before-v15-20260922T082114Z.tar.gz`

正式切换前，在 `127.0.0.1:8897` 用生产数据库副本启动隔离 v15 实例。健康接口返回 32 课和 v15；S03 公开接口保留 `S03-A-01`–`S03-A-05` 与 `S03-B-01`–`S03-B-05`，每道公开记录只有编号、阶段、题干和选项；五个知识点标题及学习说明与教师源文件一致。副本数据库完整性正常，用户、场次、作答和学习完成数分别为 64、4、1649、169。本轮没有在副本中创建新场次或使用真实学生账号作答。

生产容器于 `2026-09-22T08:22:50Z` 开始切换，`2026-09-22T08:22:53Z` 完成。切换后内网和公网健康接口均返回 `status=ok`、`lesson_count=32` 和 `bank_version=ml-v15-s03-terminology-2026-09-22`，容器健康状态为 `healthy`。SQLite 完整性仍为 `ok`，上述四类记录数与切换前一致。场次 7、8、9、11 分别继续读取 v4、v6、v11、v11 快照。旧镜像 `ml-check:2026-09-22-v14` 保留，可与上述备份配合回退。

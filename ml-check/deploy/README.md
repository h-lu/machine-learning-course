...
首页应显示 32 课；教师登录后可在 `/ml-check/teacher` 创建场次、切换 A/学习/B 阶段并导出 CSV，学生在 `/ml-check/current` 作答。每课有 5 个独立知识点及对应的 A/B 题；AI 学习页只显示知识点标题和学习说明。健康接口报告题库版本 `ml-v4-2026-09-14`，旧题库读取 API 和匿名答题路径仍保留兼容。

...
随后按首次出现顺序复核第 05 课术语，并以 `ml-v15-s03-terminology-2026-09-22` 发布。v15 为模型、特征、标签／目标值、模型参数、拟合、数据划分、MAE、随机种子和两类泄漏补充就地解释，并同步 S03 的 AI 学习说明；v14 仍作为上一版历史记录保留。提交、验证与部署证据见[发布说明](../RELEASE.md)。

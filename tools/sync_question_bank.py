...
def main():
    ...
    for id in LESSONS:
        ...
        if id.startswith("C"):
            ...
            module = ["任务与评估", "经典学习", "深度学习与注意力", "语言模型与应用", "连续决策与使用"][((int(id[1:]) - 1) // 6)]
    ...
    target.write_text(json.dumps({"version": "ml-v7-intro-2026-09-19", "lessons": lessons}, ensure_ascii=False, indent=2) + "\n")
